    ...
    public ServerFrame() {
        ...
        (new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                {
                    // jta.setText(st.cmap.get(jlClients.getSelectedValue().toString()).receiveContent);
                    // //就在收到的文本框内显示内容
                }
            }
        });
            ...
            public void actionPerformed(ActionEvent e) {
                if (jlClients.getSelectedValue() != null) {
                    try {
                        ...
                        if (code == 0) {
                            // DataOutputStream
                            // dout=st.cmap.get(jlClients.getSelectedValue().toString()).dout;
                            ...
                            // IOUtil.sendFloat(dout,
                            // Float.parseFloat(jtf.getText().trim()));
                        } else if (code == 2) {
                            // DataOutputStream
                            // dout=st.cmap.get(jlClients.getSelectedValue().toString()).dout;
