...
import static com.bn.util.IOUtil.readInt;
import static com.bn.util.IOUtil.readStr;
...
public class ServerAgentThread extends Thread {
    ...
    private void broadcastCardLandlord() // 发6 给所用人 现在的牌权 倍数 可不可不出牌,每家的牌的剩余量
                                         // 告诉每家出的牌的个数 以及牌的索引
    {
            ...
            try {
                ...
                if (code == 0) {
                    ...
                    if (GameData.prepareCount == 3) {
                        ...
                        // GameData.landlord=(int)(Math.random()*2);
                        // //随机选一个玩家去先选地主
                        GameData.landlord = 2;
                        Thread.sleep(2000);
                ...
                } else if (code == 1) // data=1叫地主，data=0 不叫
                {
                    ...
                    if (data == 1 && GameData.landlordCount != 4) {
                        GameData.landlordList.add(index); // 添加进 叫地主的列表
